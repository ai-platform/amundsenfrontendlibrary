...
describe('TableListItem', () => {
  ...
  describe('getLink', () => {
    it('getLink returns correct string', () => {
      ...
      expect(wrapper.instance().getLink()).toEqual(`/explore/table_detail/${table.cluster}/${table.database}/${table.schema}/${table.name}?index=${logging.index}&source=${logging.source}`);
    });
  });
